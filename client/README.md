...
This application is hosted on AWS EC2 instance: http://ec2-54-175-86-99.compute-1.amazonaws.com/

Nginx is pointing at the build folder which is generated by

### $npm run build

Then I use PM2 to manage it.
